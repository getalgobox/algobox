...
class ABObserver(object):
    ...
    would be apparent from our timeseries store and database for later analysis.

    Attributes:
        * events (list) a list of events generated by the BacktestManager.
            this includes the following types of events:
            core.const.Event.SIGNAL_BUY: a signal has been generated to buy
            core.const.Event.SIGNAL_BUY: a signal has been generated to sell
            core.const.Event.TRANSACTION_BUY: we acted on a buy signal
            core.const.Event.TRANSACTION_SELL: we acted on a sell signal
            core.const.Event.EQUITY_UPDATE: the current account equity
            core.const.Event.PRICE_UPDATE: the current asset price
            core.const.Event.CASH_UPDATE: the current amount of cash we have
    """
